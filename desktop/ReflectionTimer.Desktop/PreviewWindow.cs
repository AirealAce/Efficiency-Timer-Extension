...
internal sealed partial class PreviewWindow : Form, IReflectionPromptWindow, IReflectionShortcutTarget
{
    ...
    internal PreviewWindow(PreviewApplication app, string view, Guid? prompt)
    {
        ...
        Text = view == "main" ? "Reflection Timer — App view · 4.1.14" : view == "compact" ? "Reflection Timer — Compact view · 4.1.14" : "Reflection Timer — Session end · 4.1.14";
    ...
    private async void Receive(object? sender, CoreWebView2WebMessageReceivedEventArgs e)
    {
        ...
        try {
            ...
            if(handoffInProgress && action is "queue" or "saveForLater" or "skip" or "close" or "navigateReflection")throw new InvalidOperationException("This reflection is being saved before another prompt opens.");
            ...
            if(View=="reflection"&&!ReflectionOpen&&(action is "draft" or "saveForLater" or "queue" or "skip" or "navigateReflection" or "close"))throw new InvalidOperationException("This reflection is closed. Reopen it before editing.");
            ...
            if (action == "compactSize") {
                ...
                ApplyTopMost();
                Text="Reflection Timer — "+(IsTimeOnly?"Time-only":"Compact")+" view · 4.1.14";
            ...
            if (action is "draft" or "saveForLater" or "queue" or "skip") {
