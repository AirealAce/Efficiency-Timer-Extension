...
The primary app is now the accessible Windows desktop version, **4.1.3**. Its HTML interface runs inside a C# / WebView2 desktop host and uses the existing timer engine, encrypted storage, MP3 library, and Google Sheets receiver.
