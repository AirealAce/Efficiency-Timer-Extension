...
1. Open [the latest release](https://github.com/AirealAce/Reflection-Timer/releases/latest) and download **ReflectionTimer-3.12.4-win-x64.zip** under Assets. GitHub's **Code → Download ZIP** and **Source code** downloads are for developers.
