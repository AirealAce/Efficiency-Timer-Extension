# Archived Chrome extension

This folder is the preserved extension version. In Chrome's Extensions page, enable Developer mode and choose Load unpacked for **this folder** if you need to inspect it. The current app is in ../desktop. Do not run this extension alongside the desktop timer. Run this archive's tests from this folder with node --test. The original combined project documentation follows for historical reference.
